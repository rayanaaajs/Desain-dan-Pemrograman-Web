...
<section>
    ...
    <form id="form-tambah" method="post" action="proses_edit.php" onsubmit="return confirm('Yakin ingin menyimpan perubahan data ini?');">
        <!-- Input rahasia untuk menyimpan ID buku yang diedit -->
        ...
        <p>
            ...
            <input type="number" id="tahun" name="tahun" value="<?php echo $buku['tahun']; ?>" min="1900" max="2026" required>
        </p>
        <p>
        ...
        <p>
            ...
            <input type="number" id="stok" name="stok" value="<?php echo $buku['stok']; ?>" min="0" required>
        </p>
        <p>
